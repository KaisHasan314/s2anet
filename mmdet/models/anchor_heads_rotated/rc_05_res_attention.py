...
class RC_05_Res_Attention(nn.Module):
    ...
    def __init__(self,
                 ...
                 loss_odm_xwh_bbox=dict(
                     type='SmoothL1Loss', beta=1.0 / 9.0, loss_weight=1.0)):
        super(RC_05_Res_Attention, self).__init__()
    ...
    def forward_single(self, x, stride):
        ...
        for i, fam_reg_conv in enumerate(self.fam_reg_convs):
            ...
            fam_reg_feat = fam_reg_feat * attention + fam_reg_feat  # added this
        ...
        if self.training:
            ...
            for i, fam_cls_conv in enumerate(self.fam_cls_convs):
                ...
                fam_cls_feat = fam_cls_feat * attention + fam_cls_feat  # added this
        ...
        for i, odm_reg_conv in enumerate(self.odm_reg_convs):
            ...
            odm_reg_feat = odm_reg_feat * attention + odm_reg_feat  # added this
        ...
        for i, odm_cls_conv in enumerate(self.odm_cls_convs):
            ...
            odm_cls_feat = odm_cls_feat * attention + odm_cls_feat  # added this
